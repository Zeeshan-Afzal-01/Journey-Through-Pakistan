          ...
          <div className="col-12">
            <div className="d-flex justify-content-between align-items-start mb-3">
              ...
              <div className="d-flex gap-2">
                {isMe ? (
                  <>
                    <Link to="/chats" className="btn btn-light rounded-pill d-flex align-items-center gap-2" style={{ backgroundColor: '#e4e6eb', color: '#050505', border: 'none' }}>
      ...
      <div className="container-fluid px-4 pb-4">
        <div className="row g-3">
          ...
          <div className="col-12 col-lg-6">
            ...
            {activeTab === 'about' && (
              <div className="card shadow-sm" style={{ border: 'none', backgroundColor: '#fff' }}>
                <div className="card-body">
                  <h5 className="fw-bold mb-4" style={{ fontSize: '24px', color: '#050505' }}>About</h5>
                  <div className="mb-4">
                    <h6 className="fw-bold mb-3" style={{ fontSize: '17px', color: '#050505' }}>Basic Information</h6>
                    {editingField === 'name' && isMe ? (
                      <div className="mb-3">
                        <div className="d-flex align-items-center gap-3">
                          <FiUser className="text-muted" style={{ minWidth: '20px' }} />
                          <div className="flex-grow-1">
                      ...
                      <div className="d-flex align-items-center gap-3 mb-3">
                        <FiUser className="text-muted" style={{ minWidth: '20px' }} />
                        <div className="flex-grow-1">
                          <div className="small text-muted" style={{ fontSize: '13px', color: '#65676b' }}>Name</div>
                          <div className="d-flex align-items-center gap-2">
                            <div className="fw-semibold" style={{ fontSize: '15px', color: '#050505' }}>{viewingUser.name}</div>
                            {isMe && (
                              <button 
                                className="btn btn-link p-0 text-decoration-none"
                                onClick={() => handleEditField('name')}
                                style={{ color: '#65676b', padding: '2px 4px' }}
                                title="Edit name"
                              >
                                <FiEdit2 size={14} />
                              </button>
                    ...
                    {editingField === 'city' && isMe ? (
                      <div className="mb-3">
                        <div className="d-flex align-items-center gap-3">
                          <FiMapPin className="text-muted" style={{ minWidth: '20px' }} />
                          <div className="flex-grow-1">
                      ...
                      <div className="d-flex align-items-center gap-3 mb-3">
                        <FiMapPin className="text-muted" style={{ minWidth: '20px' }} />
                        <div className="flex-grow-1">
                          <div className="small text-muted" style={{ fontSize: '13px', color: '#65676b' }}>City</div>
                          <div className="d-flex align-items-center gap-2">
                            <div className="fw-semibold" style={{ fontSize: '15px', color: '#050505' }}>{viewingUser.city}</div>
                            {isMe && (
                              <button 
                                className="btn btn-link p-0 text-decoration-none"
                                onClick={() => handleEditField('city')}
                    ...
                    {viewingUser?.email && (
                      <div className="d-flex align-items-center gap-3 mb-3">
                        <FiMail className="text-muted" style={{ minWidth: '20px' }} />
                        <div>
                          <div className="small text-muted" style={{ fontSize: '13px', color: '#65676b' }}>Email</div>
                          <div className="fw-semibold" style={{ fontSize: '15px', color: '#050505' }}>{viewingUser.email}</div>
                        </div>
                      </div>
                    )}
                  </div>
                  {editingField === 'bio' && isMe ? (
                    <div className="mb-4">
                      <h6 className="fw-bold mb-3" style={{ fontSize: '17px', color: '#050505' }}>Bio</h6>
                      <textarea 
                        className="form-control"
                        rows="4"
                        value={editFormData.bio}
                    ...
                    <>
                      {viewingUser?.bio && (
                        <div className="mb-4">
                          <div className="d-flex align-items-start gap-2 mb-2">
                            <h6 className="fw-bold mb-0" style={{ fontSize: '17px', color: '#050505' }}>Bio</h6>
                            {isMe && (
                              <button 
                                className="btn btn-link p-0 text-decoration-none"
                                onClick={() => handleEditField('bio')}
                          ...
                          <p style={{ fontSize: '15px', color: '#050505' }}>{viewingUser.bio}</p>
                        </div>
                      )}
                      {isMe && !viewingUser?.bio && (
                        <div className="mb-4">
                          <h6 className="fw-bold mb-2" style={{ fontSize: '17px', color: '#050505' }}>Bio</h6>
                          <button 
                            className="btn btn-link p-0 text-decoration-none"
                            onClick={() => handleEditField('bio')}
                            style={{ color: '#1877f2', fontSize: '15px' }}
