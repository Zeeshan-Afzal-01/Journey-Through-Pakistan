...
export default function Settings() {
  ...
  useEffect(() => {
    if (user) {
      ...
      if (user.isProfilePrivate !== undefined) {
  ...
  const handlePrivacyToggle = async () => {
    const newPrivacyValue = !isProfilePrivate;
    setLoading(true);
    try {
      const res = await updateMe({
        isProfilePrivate: newPrivacyValue
      });
    ...
    <div className="settings-page">
      <div className="settings-container">
        ...
        <section className="settings-section">
          ...
          <div className="toggle-list" style={{ marginBottom: '2rem' }}>
            <div className="toggle-item">
              <div className="toggle-label">
                <div>
                  <span style={{ fontWeight: '600', display: 'block', marginBottom: '4px' }}>Profile Privacy</span>
                  <span style={{ fontSize: '0.9rem', color: '#65676b' }}>
                    {isProfilePrivate 
                      ? 'Your profile is private. Only friends can see your posts, friends list, and photos.'
                      : 'Your profile is public. Everyone can see your posts, friends list, and photos.'}
                  </span>
                </div>
              </div>
              <label className="toggle-switch">
